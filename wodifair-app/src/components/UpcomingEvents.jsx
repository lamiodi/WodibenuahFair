        ...
        if (Array.isArray(data) && data.length > 0) {
          const mapped = data.map(ev => {
            const dateStr = ev.start_date
              ? new Date(ev.start_date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' }).toUpperCase()
              : 'DECEMBER 13, 2026';
            const city = ev.location?.toLowerCase().includes('abuja') ? 'Abuja' : 'Lagos';
            return {
              id: ev.id,
              date: dateStr,
              title: ev.title || 'Wodibenuah Fair',
              subtitle: ev.description ? ev.description.slice(0, 45) : 'Exhibition Edition',
              category: 'Exhibition',
              location: ev.location,
              city,
              image: ev.image_url || 'https://res.cloudinary.com/dwmz4youk/image/upload/v1779310067/wodifair/Lagosdecember12thedition.png',
              mapUrl: ev.map_link || 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d209927.16994260912!2d3.3535174980813856!3d6.520877071059808!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103bf57f27da3ee1%3A0x3a690cd5fd98ed0e!2sThe%20Five%20Palm%20Oniru!5e1!3m2!1sen!2sng!4v1785822446153!5m2!1sen!2sng',
              directionsUrl: `https://maps.google.com/?q=${encodeURIComponent(ev.location)}`
            };
          });
          setEvents(mapped);
        }
    ...
    <section className="bg-cream border-b border-deep-black overflow-hidden">
      <div className="flex flex-col lg:flex-row h-auto lg:h-[800px]">
        ...
        {(() => {
          ...
          const selectedEvent = events[safeIndex] || DEFAULT_EVENTS[0];
                ...
                <div className="pointer-events-auto">
                   ...
                   >
                     ...
                     <p className="text-gray-300 text-lg md:text-xl font-body italic mb-8 max-w-md">
                       {selectedEvent.location} &bull; {selectedEvent.subtitle}
                     </p>

                     <div className="flex flex-wrap gap-4 mb-8">
                        <Link 
                          to={`/register?location=${selectedEvent.city}`}
